...
var div1 = dom.create("<div>\u7B2C\u4E00\u4E2Adiv</div>");
var div2 = dom.create("<div>\u7B2C\u4E8C\u4E2Adiv</div>");
var div22 = dom.create("<div>\u7B2C\u4E8C\u4E8C\u4E2Adiv</div>");
var div23 = dom.create("<div>\u7B2C\u4E8C\u4E09\u4E2Adiv</div>");
dom.after(tag, div1);
dom.before(tag, div2);
...
console.log("title: ".concat(dom.attr(div2, 'title')));
...
dom.each(siblings.children, function (n) {
  dom.style(n, {
